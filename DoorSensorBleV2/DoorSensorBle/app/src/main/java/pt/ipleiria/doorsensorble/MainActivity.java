...
public class MainActivity extends Activity {
    ...
    //TODO fazer isto estar a fazer advertise de x em x tempo com duraçao de y secs
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO testing, remover e implementar como deve ser depois
        DeviceProfile.encryptionTest(degreeSimplified);
...
//        byte [] data = DeviceProfile.generateData(degreeSimplified);
        byte [] data = DeviceProfile.encryptionTest(degreeSimplified);
...
//                .addServiceData(pUuid, data)
                .addManufacturerData(DeviceProfile.MANUFACTURER_ID, data)
                .build();
